package hosm.android.osmtracker.osm;
...
import hosm.android.osmtracker.osm.ProgressMultipartEntity.ProgressListener;
import hosm.android.osmtracker.util.DialogUtils;
...
public class UploadToOpenStreetMapTask extends AsyncTask<Void, Void, Void> {
	...
	protected void onPreExecute() {
		try {
			...
			// API parameters
			entity.addPart(OpenStreetMapConstants.Api.Gpx.Parameters.FILE, new FileBody(gpxFile, filename));
