...
import hosm.android.osmtracker.view.DisplayTrackView;
			...
			dtv.post(new Runnable() {
				...
				public void run() {
					new AlertDialog.Builder(DisplayTrack.this)
						.setTitle(hosm.android.osmtracker.R.string.prefs_displaytrack_osm)
						.setMessage(hosm.android.osmtracker.R.string.prefs_displaytrack_osm_summary_ask)
						.setNegativeButton(android.R.string.no, null)
						.setPositiveButton(hosm.android.osmtracker.R.string.displaytrack_map, new DialogInterface.OnClickListener() {
							@Override
